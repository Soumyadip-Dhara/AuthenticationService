...
public partial class IDPDBContext1 : DbContext
{
    public IDPDBContext1()
    {
    }

    public IDPDBContext1(DbContextOptions<IDPDBContext1> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<UserMaster200525> UserMaster200525s { get; set; }
