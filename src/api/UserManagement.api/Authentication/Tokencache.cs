...
namespace UserManagement.api.Authentication
{
    public class Tokencache : ITokencache
    {
        ...
        public Tokencache(ILogger<Tokencache> logger, IConfiguration Configuration)
        {
            ...
            TokenCachEvictionTimeinMint = _Configuration.GetValue<int>("Auth:TokenCachEvictionTimeinMint", 30);
            TokenCacheMaxItemCount = _Configuration.GetValue<int>("Auth:TokenCacheMaxItemCount", 400);
        }
        //private Tokencache()
        //{
